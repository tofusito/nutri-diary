...
function Login({ onLogin }) {
  ...
  return <main className="login"><img className="brand-icon" src="/noodle-shadow-192.png?v=10" alt="" /><p className="eyebrow">NUTRI</p><h1>Tu nutrición,<br />en claro.</h1><p>Un diario privado, simple y vuestro.</p>
